...
public class Main {
    public static void main(String[] args) {
        ...
        Deque toDoDeque = new ArrayDeque(numberOfTasks); // создаем очередь
        Boss boss = new Boss(toDoDeque); // создаем начальника с ссылкой на
        // очередь
        Worker worker = new Worker(toDoDeque); // то же самое делаем с рабочим
